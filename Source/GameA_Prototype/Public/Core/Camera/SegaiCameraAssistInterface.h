...
#include "SegaiCameraAssistInterface.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class USegaiCameraAssistInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class GAMEA_PROTOTYPE_API ISegaiCameraAssistInterface
{
	GENERATED_BODY()
