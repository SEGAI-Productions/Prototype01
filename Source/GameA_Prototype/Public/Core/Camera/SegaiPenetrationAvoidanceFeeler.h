...
#include "SegaiPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FSegaiPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FSegaiPenetrationAvoidanceFeeler()
	...
	FSegaiPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
